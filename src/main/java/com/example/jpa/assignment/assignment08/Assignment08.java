...
public class Assignment08 {
    ...
    private final List<Car5> entityList = List.of(
            new Car5("Ford", "Focus", 10_000, 15_000, 1234),
            new Car5("Mercedes", "E", 100_000, 150_000, 456),
            new Car5("BMW", "Xcs", 180_000, 18_000, 789),
            new Car5("Fiat", "500", 80_000, 8_000, 108)
    );
    ...
    public void persistNewEntities() {
        ...
        var rentalContract = List.of(
                ...
                new RentalContract2(getEntityById(3, Customer5.class), getEntityById(1, Car5.class), 3000, 4000),
                new RentalContract2(getEntityById(3, Customer5.class), getEntityById(2, Car5.class), 3000, 4000),
